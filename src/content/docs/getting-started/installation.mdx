...
Wondering whether anyone else runs this? [In the wild](/in-the-wild/) collects
what other developers have written about Truss, with a link to every source.
...
Truss is installed and run against real open-source Laravel applications, and
[what happened in each one](/reference/tested-applications/) is published,
including the two where it did not work at first.
